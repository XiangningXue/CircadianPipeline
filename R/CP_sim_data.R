#' Title Simulating Data for Rhythmicity Comparison
#'
#' CP_sim_data simulates a simple two-group study. The simulated data is just used for illustration purposes and is not intended to mimic real data.
#' @param ngene integer. Number of features for both groups
#' @param nsample integer. Number of samples for both groups
...
#' @param sigma1 integer. Noise level for group I.
#' @param sigma2 integer. Noise level for group II.
#'
...
CP_sim_data = function(ngene=1000, nsample=30, A1=c(1, 3), A2=c(1, 3), phase1=c(0, 2*pi), phase2=c(0, 2*pi), M1=c(4, 6), M2=c(4, 6), sigma1=1, sigma2=1){
